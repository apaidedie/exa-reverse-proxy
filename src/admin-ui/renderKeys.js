...
export function renderDetails() {
  ...
  el('detailsBody').innerHTML =
    ...
    '<section class="detail-section"><h3>近 24 小时</h3><div class="detail-kpis"><div class="detail-kpi"><span>请求</span><strong>' + fmt(observedRequests) + '</strong></div><div class="detail-kpi"><span>成功率</span><strong class="good">' + successRate + '</strong></div><div class="detail-kpi"><span>失败率</span><strong class="bad">' + failureRate + '</strong></div><div class="detail-kpi"><span>429 比例</span><strong class="warn">' + rateLimitRate + '</strong></div></div><div class="detail-row"><span>超时比例</span><span>' + pct(key.timeoutCount, observedRequests) + '</span></div><div class="detail-row"><span>最后延迟</span><span>' + ms(key.lastLatencyMs) + '</span></div></section>' +
