...
echo   docker run -d -p 127.0.0.1:8787:8787 --env-file .env -v exa_proxy_data:/data -e EXA_STATE_PATH=/data/exa-proxy.sqlite %DOCKER_USERNAME%/%IMAGE_NAME%:%IMAGE_TAG%
echo.
